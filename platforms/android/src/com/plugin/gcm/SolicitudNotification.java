...
public class SolicitudNotification implements Notificacion {
	...
	public String getBody() {
		// TODO Auto-generated method stub
		return Contacto+" quiere agregarte a su lista de contactos.";
	}
	...
	public Bitmap getLargeIcon(int cant) {
		Context context=NotificationStack.gcm;
		int bgId=context.getResources().getIdentifier("icon_white_friend", "drawable", context.getPackageName());
		if(android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP)
			bgId=context.getResources().getIdentifier("friend", "drawable", context.getPackageName());
	...
	public int getSmallIcon(int size) {
		// TODO Auto-generated method stub
		Context context=NotificationStack.gcm;
		return context.getResources().getIdentifier("icon_white_friend", "drawable", context.getPackageName());
	}
	@Override

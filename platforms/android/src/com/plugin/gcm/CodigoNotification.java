...
public class CodigoNotification implements Notificacion {
	...
	public String getBody() {
		// TODO Auto-generated method stub
		return Contacto+" se registró con tu código de promoción.";
	}
	...
	public Bitmap getLargeIcon(int cant) {
		...
		if(android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP)
			bgId=context.getResources().getIdentifier("promo", "drawable", context.getPackageName());

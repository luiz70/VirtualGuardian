...
public class PersonalNotification implements Notificacion {
	...
	public String getTitle() {
		...
		if(Distancia<1000)return d.getAsunto(Asunto)+" a "+Distancia+"m. de ti.";
		else {
			double x=(double)Distancia/1000;
			return d.getAsunto(Asunto)+" a "+String.format("%.1f",x)+"km. de ti.";
		}
	}
	...
	public Bitmap getLargeIcon(int cant) {
		Context context=NotificationStack.gcm;
		int bgId=context.getResources().getIdentifier("icon_white_personal", "drawable", context.getPackageName());
		if(android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP)
			bgId=context.getResources().getIdentifier("alertapersonal", "drawable", context.getPackageName());
	...
	public int getSmallIcon(int size) {
		// TODO Auto-generated method stub
		Context context=NotificationStack.gcm;
		return context.getResources().getIdentifier("icon_white_personal", "drawable", context.getPackageName());
	}
	@Override
